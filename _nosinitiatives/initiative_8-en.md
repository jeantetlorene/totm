...
<ul>
    <li>Develop collaborations to ensure effective care (from rescue to rehabilitation) for marine turtles by veterinarians and rehabilitation centers</li>
    <li>Provide technical support for establishing new rehabilitation centers and optimizing existing ones</li>
    <li>Position rehabilitation centers as key actors in marine turtle conservation</li>
</ul>  

**Objective 2: Improve the care of marine turtles**

<ul>
    <li>Develop methods to assess pain and stress in marine turtles</li>
    <li>Identify reliable parameters to evaluate the health status of marine turtles</li>
    <li>Identify indicators to assess a turtle’s readiness for release into the wild</li>
</ul>  
