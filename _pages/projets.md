...
banners:
  ...
  - title: "Impact de la pêche INN sur la dynamique de population des tortues luth en Guyane Française "
    ...
    description: |-
      ...
      Ce projet vise à étudier l’interaction entre la pêche INN et ces populations de tortues afin de spatialiser les zones à risque et de définir les zones maritimes prioritaires pour leur conservation. Les cartes et analyses produites seront mises à disposition des institutions locales et des partenaires de gestion pour soutenir la planification et la surveillance, et présentées à la COP30 de Belém afin d’informer les discussions régionales sur la protection des tortues marines et l’orientation des actions de conservation en Guyane française.
    fiche: "Initiatives_TOTM_21_12_2022.pdf"
  ...
  - title: "Développement d’un protocole de collecte de données sur la pêche INN en Guyane française"
    ...
    description: |-
      ...
      Mission de TOTM : concevoir un protocole harmonisé de collecte et d’analyse des données, reproductible à l’échelle de l’est guyanais, afin d’améliorer le suivi des activités de pêche illégale.
    fiche: "Initiatives_TOTM_21_12_2022.pdf"
  ...
  - title: "Développer des méthodes d’évaluation de la douleur et du stress chez les tortues "
    ...
    description: |-
      ...
      Ces paramètres étant difficilement quantifiables, l’utilisation d’analgésiques de façon systématique lors de l’arrivée des tortues marines dans le centre de soin devrait être mise en place. L’objectif de cette action est donc d’étudier le stress et la douleur des tortues marines et de proposer des solutions pour y pallier.

      TOTM travaille dans un premier temps sur une synthèse bibliographique à propos des tortues marines et :
      - le stress aigu
      - le stress chronique et les tissus kératinisés
      - la douleur

      Des axes de recherche sont proposés à la suite de cette revue, et TOTM est à la recherche de partenaires pour les développer.
    fiche: "Initiatives_TOTM_21_12_2022.pdf"
